            ...
            {projects.map((project) => (
              ...
              >
                ...
                {posts[0] && (
                  <div
                    key={posts[0].id}
                    className="relative mt-8 flex items-center gap-x-4 justify-self-end"
                  >
                    <div className="text-sm/6">
                      ...
                      <p className="text-gray-400">{posts[0].name}</p>
                    </div>
                  </div>
                )}
              </article>
